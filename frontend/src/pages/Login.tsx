            ...
            <div>
              ...
              <div className="mt-1 grid grid-cols-2 gap-3">
                ...
                <div
                  ...
                  className={`cursor-pointer p-3 border rounded-md text-center flex flex-col items-center gap-2 transition-all ${role === 'seller' ? 'border-quantum-500 bg-quantum-50 ring-1 ring-quantum-500' : 'border-slate-300 hover:bg-slate-50'}`}
                >
                  <User className={role === 'seller' ? 'text-quantum-600' : 'text-slate-400'} />
                  <span className={`text-sm font-medium ${role === 'seller' ? 'text-quantum-900' : 'text-slate-500'}`}>Seller</span>
                </div>
              </div>
            </div>
