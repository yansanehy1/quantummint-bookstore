...
import { BookOpen, Wallet as WalletIcon, ArrowDown, ArrowUp, History } from "lucide-react";
                  ...
                  {providers.map((provider) => (
                    <button
                      ...
                      className={`p-4 rounded-lg border-2 transition text-left ${
                        selectedProvider === provider.id ? "border-amber-600 bg-amber-50" : "border-gray-200 hover:border-amber-600"
                      }`}
                    >
              ...
              <div className="mb-8">
                ...
                <div className="flex gap-4">
                  <div className="flex-1">
                    <Input type="number" placeholder="Enter amount" value={depositAmount} onChange={(e) => setDepositAmount(e.target.value)} className="py-2 h-12" />
                  </div>
