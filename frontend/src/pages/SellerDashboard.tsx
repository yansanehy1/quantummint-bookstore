...
import { BookOpen, TrendingUp, DollarSign, Users, Plus, Edit2, Eye, Trash2, Download } from "lucide-react";
                    ...
                    <Card key={book.id} className="p-6 border-l-4 border-amber-600">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button onClick={() => setLocation("/book-editor/" + book.id)} variant="outline" size="sm">
                            <Edit2 className="w-4 h-4" />
                          </Button>
                          <Button onClick={() => handleDeleteBook(book.id)} variant="outline" size="sm" className="text-red-600 hover:text-red-700">
