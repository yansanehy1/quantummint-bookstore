            ...
            <div>
              ...
              <div className="flex gap-2">
                {(["week", "month", "all"] as const).map((range) => (
                  <Button key={range} onClick={() => setTimeRange(range)} variant={timeRange === range ? "default" : "outline"} className={timeRange === range ? "bg-blue-600 text-white" : "text-gray-700"}>
            ...
            <div>
              ...
              <div className="flex gap-2">
                {(["all", "reading", "listening"] as const).map((type) => (
                  <Button key={type} onClick={() => setSessionType(type)} variant={sessionType === type ? "default" : "outline"} className={sessionType === type ? "bg-purple-600 text-white" : "text-gray-700"}>
