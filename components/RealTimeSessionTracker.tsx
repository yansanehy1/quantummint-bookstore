...
import { BookLevel } from "../services/readingSessionManager";
    ...
    <Card className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 sticky top-4 z-40">
      <div className="space-y-4">
        <div className="flex justify-between items-start">
          <div>
            <h3 className="font-bold text-slate-900">Real-Time Pay-Per-Use Session</h3>
        ...
        <div className="grid grid-cols-4 gap-2">
          <div className="bg-white rounded-lg p-3 border border-blue-100">
            ...
            <p className="text-sm font-bold text-slate-900">{summary.duration}</p>
          </div>
          ...
          <div className="bg-white rounded-lg p-3 border border-purple-100">
            <div className="flex items-center gap-1 mb-1">
              ...
              <p className="text-xs font-medium text-slate-600">Rate</p>
            </div>
            <p className="text-sm font-bold text-slate-900">{chargePerMinute.toFixed(3)} L/min</p>
          </div>
        </div>
        ...
        {showTransactions && chargeState.transactions.length > 0 && (
          <div className="bg-white rounded-lg border border-slate-200 p-3 max-h-48 overflow-y-auto">
            <p className="text-xs font-semibold text-slate-700 mb-2">Transaction History</p>
            <div className="space-y-1">
              {chargeState.transactions.map((txn) => (
                <div key={txn.id} className="text-xs text-slate-600 flex justify-between">
