...
import { estimateReadingTime, BookLevel } from "../services/readingSessionManager";
    ...
    <Card className="p-6 bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200">
      <div className="space-y-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-bold text-lg text-slate-900">Access Required</h3>
            <p className="text-sm text-slate-700">You don't have access to this book yet. Choose an option below.</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 border border-amber-200">
          <div className="flex items-start justify-between mb-3">
            <div>
              ...
              <p className="text-sm text-slate-600 mt-1">Own the book forever. Unlimited reading and listening.</p>
            </div>
        ...
        <div className="bg-white rounded-lg p-4 border border-green-200">
          <div className="flex items-start justify-between mb-3">
            <div>
              ...
              <p className="text-sm text-slate-600 mt-1">Read or listen by the hour. No long-term commitment.</p>
            </div>
