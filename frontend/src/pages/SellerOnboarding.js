    ...
    return (<div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
      ...
      <main className="container max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      {task.action && (<button_1.Button onClick={() => handleTaskAction(task.id, task.actionUrl)} size="sm" className={task.status === "completed" ? "bg-gray-400" : "bg-amber-600 hover:bg-amber-700"} disabled={task.status === "completed"}>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <card_1.Card className="p-6 hover:shadow-lg transition">
              ...
              <button_1.Button variant="outline" size="sm">Read Guide</button_1.Button>
            </card_1.Card>
            <card_1.Card className="p-6 hover:shadow-lg transition">
              ...
              <button_1.Button variant="outline" size="sm">Join Community</button_1.Button>
            </card_1.Card>
            <card_1.Card className="p-6 hover:shadow-lg transition">
              ...
              <button_1.Button variant="outline" size="sm">Learn More</button_1.Button>
            </card_1.Card>
          </div>
        </section>
        ...
        <section className="flex gap-4 justify-center mb-12">
          <button_1.Button onClick={() => setLocation("/seller-dashboard")} className="bg-amber-600 hover:bg-amber-700 px-8">Go to Seller Dashboard</button_1.Button>
          <button_1.Button onClick={() => setLocation("/audiobook-creator")} variant="outline" className="px-8">Create Your First Book</button_1.Button>
        </section>
