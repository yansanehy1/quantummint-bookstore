                            ...
                            {msg.chunks && msg.chunks.length > 0 && (
                                <div className="mt-3 space-y-2">
                                    {msg.chunks.map((chunk: any, cIdx: number) => {
                                        if (chunk.web?.uri) {
                                            return (
                                                <a key={cIdx} href={chunk.web.uri} target="_blank" rel="noopener noreferrer" className="block bg-blue-50 hover:bg-blue-100 p-3 rounded-lg border border-blue-200 transition-colors group">
