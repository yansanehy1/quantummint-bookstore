      ...
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-slate-800 flex items-center justify-center gap-2">
            <Sparkles className="text-quantum-600" />
                ...
                <div className="relative rounded-xl overflow-hidden bg-black">
                   ...
                   <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-4">
                      ...
                      <button 
                        ...
                        className="w-16 h-16 bg-white rounded-full border-4 border-slate-300 hover:border-quantum-500 transition-colors"
                      />
                   </div>
                </div>
              ) : (
           ...
           <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-quantum-500 focus:outline-none h-24 resize-none"
                />
              </div>
              <Button 
        ...
        {/* Results Area */}
        {result && (
          <div className="bg-white p-6 rounded-xl shadow-lg border border-quantum-100 animate-fade-in">
