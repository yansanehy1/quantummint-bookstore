    ...
    return (<div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
      ...
      <main className="container max-w-6xl mx-auto px-4 py-12">
        ...
        <section className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <card_1.Card className="p-6">
            <div className="flex items-center justify-between">
              ...
              <lucide_react_1.TrendingUp className="w-12 h-12 text-green-600 opacity-20"/>
            </div>
          </card_1.Card>
          <card_1.Card className="p-6">
            <div className="flex items-center justify-between">
              ...
              <lucide_react_1.TrendingUp className="w-12 h-12 text-amber-600 opacity-20"/>
            </div>
          </card_1.Card>
        </section>
        ...
        <section className="grid md:grid-cols-2 gap-8 mb-12">
          <card_1.Card className="p-8 bg-gradient-to-br from-purple-50 to-pink-50">
            ...
            <div className="bg-white border-2 border-purple-200 rounded-lg p-6 mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <button_1.Button onClick={handleCopyCode} variant="outline" size="sm" className="ml-auto">
          ...
          <card_1.Card className="p-8 bg-gradient-to-br from-cyan-50 to-blue-50">
            ...
            <div className="bg-white border-2 border-cyan-200 rounded-lg p-6 mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <button_1.Button onClick={handleCopyLink} variant="outline" size="sm" className="ml-auto flex-shrink-0">
                  <lucide_react_1.Copy className="w-4 h-4 mr-2"/>
                  {copied ? "Copied!" : "Copy"}
                </button_1.Button>
              </div>
            </div>
            <button_1.Button className="w-full bg-cyan-600 hover:bg-cyan-700">
        ...
        <section className="mb-12">
          <card_1.Card className="p-8">
            ...
            <div className="flex gap-3 mb-6">
              <input_1.Input type="email" placeholder="Enter friend's email address" value={inviteEmail} onChange={(e) => setInviteEmail(e.target.value)} className="py-2 h-12"/>
              <button_1.Button onClick={handleSendInvite} className="bg-purple-600 hover:bg-purple-700">
        ...
        <section>
          <card_1.Card className="p-8">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  {mockReferrals.map(ref => (<tr key={ref.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-sm">
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${ref.status === "completed"
            ...
            {mockReferrals.length === 0 && (<div className="text-center py-12">
                <lucide_react_1.Users className="w-16 h-16 text-gray-300 mx-auto mb-4"/>
        ...
        <section className="mt-12">
          <card_1.Card className="p-8 bg-gradient-to-r from-amber-50 to-orange-50">
