...
import { ArrowLeft, BookOpen, Eye, Calculator, Clock, Award, Wallet } from 'lucide-react';
...
export const IntegratedEducationalReader: React.FC = () => {
  ...
  const handleProgress = (progress: number) => {
    // Progress is handled by the EnhancedMediaSyncPlayer component
  };
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            {currentPageData.audio_url && (
              <EnhancedMediaSyncPlayer
                ...
                token={token!}
                productTitle={`${book.title} - Page ${currentPage + 1}`}
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900">â ï¸ {book.average_rating.toFixed(1)}</p>
                </div>
                <div>
