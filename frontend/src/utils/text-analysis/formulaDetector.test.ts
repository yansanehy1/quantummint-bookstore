...
import { detectFormulas, latexToSpeech } from '../formulaDetector';
...
describe('Performance', () => {
  test('handles large text efficiently', () => {
    ...
    const formulas = detectFormulas(largeText);
