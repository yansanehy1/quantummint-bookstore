...
import { BookOpen, Wallet, Users, Gift, TrendingUp, LogOut, BarChart3, Settings } from "lucide-react";
      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        <div className="container max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => router.push('/')}>
            <BookOpen className="w-8 h-8 text-amber-700 stroke-2" />
      ...
      <main className="container max-w-7xl mx-auto px-4 py-16">
        ...
        <section className="mb-14 p-6 md:p-8 bg-gradient-to-r from-teal-50 to-cyan-50 rounded-2xl border border-teal-200 shadow-xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            ...
            <Button
              ...
              className="bg-teal-600 hover:bg-teal-700 text-white whitespace-nowrap min-w-[150px] transition hover:shadow-teal-300"
            >
              View Analytics
            </Button>
          </div>
        ...
        <section className="grid lg:grid-cols-3 xl:grid-cols-4 gap-8">
          ...
          {(user?.role === "seller" || user?.role === "admin") && (
            <Card className="p-8 lg:col-span-1 bg-gradient-to-br from-amber-50 to-orange-50 border-4 border-amber-300 shadow-2xl transition hover:scale-[1.02]">
          ...
          {user?.role !== "seller" && user?.role !== "admin" && (
            <Card className="p-8 lg:col-span-1 bg-gradient-to-br from-green-50 to-emerald-50 border-4 border-green-300 shadow-2xl transition hover:scale-[1.02]">
