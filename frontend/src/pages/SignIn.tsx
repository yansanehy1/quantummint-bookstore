...
export default function SignIn() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Mock successful login - in production, the role would come from the API
      // For now, let's determine role from email domain as a simple demo
      let role: 'learner' | 'creator' | 'admin' | 'support' = 'learner';

      if (formData.email.includes('creator') || formData.email.includes('teacher')) {
        role = 'creator';
      ...
      if (from) {
        ...
        // Route based on role to their default dashboard
        switch (role) {
          case 'admin':
            navigate('/admin');
            break;
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white/20">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white hover:bg-white/10 transition">
          ...
          <p className="mt-6 text-center text-sm text-gray-400">
            ...
            <Link to="/get-started" className="text-purple-400 hover:text-purple-300 font-semibold transition">
              Get Started
            </Link>
          </p>
        </div>
