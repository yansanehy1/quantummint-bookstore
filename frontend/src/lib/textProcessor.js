...
exports.detectSentences = detectSentences;
exports.detectFormulas = detectFormulas;
exports.latexToSpeech = latexToSpeech;
exports.replaceFormulasWithSpeech = replaceFormulasWithSpeech;
exports.processText = processText;
exports.isValidLatex = isValidLatex;
exports.stripFormulas = stripFormulas;
/**
 ...
 */
function replaceFormulasWithSpeech(text, formulas) {
    let result = text;
