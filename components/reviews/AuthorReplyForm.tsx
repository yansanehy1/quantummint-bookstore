    ...
    <Card className="p-4 bg-blue-50 border border-blue-200 ml-8 mt-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <Textarea
          ...
          className="w-full"
        />
        <p className="text-xs text-slate-600">{content.length}/1000 characters</p>
        ...
        <div className="bg-white rounded p-3 border border-blue-100 text-xs text-slate-600">
          <p className="font-medium text-slate-700 mb-2">Tips for a great reply:</p>
