...
jest.mock('imapflow', () => ({
  ImapFlow: jest.fn().mockImplementation(() => ({
    ...
    messageDelete: jest.fn().mockResolvedValue()
  }))
}));
...
beforeAll(async () => {
  ...
  process.env.MONGODB_URI = 'mongodb://localhost:27017/quantummint-mail-test';
  process.env.REDIS_URL = 'redis://localhost:6379/15';
  process.env.LOG_LEVEL = 'error';
  process.env.MAIL_HOSTNAME = 'test.quantummint.com';
});
