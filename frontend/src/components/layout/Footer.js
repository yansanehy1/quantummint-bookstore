...
function Footer() {
    ...
    return (<footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-300">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                <lucide_react_1.MapPin className="w-5 h-5 text-amber-500 flex-shrink-0 mt-0.5"/>
                <span className="text-sm">Freetown, Sierra Leone</span>
              </li>
              <li className="flex items-start gap-2">
                <lucide_react_1.Phone className="w-5 h-5 text-amber-500 flex-shrink-0 mt-0.5"/>
                <span className="text-sm">+232 XX XXX XXXX</span>
              </li>
              <li className="flex items-start gap-2">
                <lucide_react_1.Mail className="w-5 h-5 text-amber-500 flex-shrink-0 mt-0.5"/>
