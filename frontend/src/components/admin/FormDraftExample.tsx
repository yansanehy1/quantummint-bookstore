...
export function FormDraftExample() {
  ...
  const saveFn = async (data: FormShape) => {
    try {
  ...
  const {
    ...
    handleManualSave,
  } = useAutoSaveForm<FormShape>({ initialData, saveFn, storageKey: 'formDraft', autoLoadFromStorage: true });

  return (
    <div className="bg-white rounded p-6 shadow space-y-4 max-w-2xl">
      ...
      <fieldset className="border rounded p-3">
        ...
        <div className="grid grid-cols-2 gap-2 mt-2">
          <input
            ...
            aria-label="Personal first name"
          />
          <input
