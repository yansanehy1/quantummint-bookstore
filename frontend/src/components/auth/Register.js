      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="container max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="flex gap-4 items-center">
            ...
            <button onClick={() => setLocation("/")} className="text-amber-600 hover:text-amber-700 font-medium">
              Sign In
            </button>
          </nav>
        </div>
        ...
        {step === "role" && (<div>
            ...
            <div className="text-center">
              <p className="text-gray-600">
                ...
                <button onClick={() => setLocation("/")} className="text-amber-600 hover:text-amber-700 font-semibold">
                  Sign In
                </button>
              </p>
            </div>
            ...
            <card_1.Card className="p-8 max-w-2xl mx-auto">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <p className="text-center text-gray-600">
                  Already have an account?{" "}
                  <button type="button" onClick={() => setLocation("/")} className="text-amber-600 hover:text-amber-700 font-semibold">
                    Sign In
                  </button>
                </p>
              </form>
