...
import { BookOpen, Loader2, CheckCircle, User, Briefcase, FileText, Banknote, ClipboardCheck } from "lucide-react";

type Step = "personal" | "business" | "documents" | "tax" | "review";
...
const stepsConfig: { key: Step; label: string; icon: React.ElementType }[] = [
...
export default function AdvancedSellerRegistration() {
  ...
  const handleDocChange = (field: keyof FormData["documents"], file: File | null) => {
    setFormData((prev) => ({
      ...prev,
      documents: {
        ...prev.documents,
  ...
  const getFieldDisplay = (label: string, value: string | null | undefined, isUrl = false) => (
        ...
        <div className="container max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <Button 
                ...
                variant="outline" 
                className="hover:bg-amber-50 text-amber-700 border-amber-300 transition-colors"
                disabled={isSaving}
            >
              {isSaving ? (
                    ...
                    return (
                        <div key={s.key} className="relative flex flex-1 items-center px-2 py-3 sm:py-0 min-w-[20%]">
                            <button
                                ...
                                className={`flex flex-col sm:flex-row items-center w-full transition-all duration-300 ${
                                    isActive ? "text-amber-700 font-bold" : isCompleted ? "text-green-600 hover:text-green-700" : "text-gray-500 hover:text-gray-700"
                                }`}
                            >
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    aria-label="Country"
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition duration-150"
                ...
                <div className="md:col-span-2 space-y-2">
                  ...
                  <Textarea 
                    ...
                    placeholder="Briefly describe your background or expertise relevant to your products." 
                  />
                </div>
              </div>
              <div className="flex justify-end pt-4">
                <Button onClick={() => setActiveStep("business")} className="bg-amber-600 hover:bg-amber-700 font-semibold text-lg py-6 px-8 rounded-xl transition duration-300">
          ...
          {activeStep === "business" && (
            <div className="space-y-6">
              ...
              <div className="flex justify-between pt-4">
                ...
                <Button onClick={() => setActiveStep("documents")} className="bg-amber-600 hover:bg-amber-700 font-semibold text-lg py-6 px-8 rounded-xl transition duration-300">
          ...
          {activeStep === "documents" && (
            <div className="space-y-6">
              ...
              <div className="flex justify-between pt-4">
                ...
                <Button onClick={() => setActiveStep("tax")} className="bg-amber-600 hover:bg-amber-700 font-semibold text-lg py-6 px-8 rounded-xl transition duration-300">
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input 
                    value={formData.taxInfo.tin} 
                    onChange={(e) => handleInputChange("taxInfo", "tin", e.target.value)} 
                    placeholder="e.g., SL-123456789" 
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="flex justify-between pt-4">
                ...
                <Button onClick={() => setActiveStep("review")} className="bg-amber-600 hover:bg-amber-700 font-semibold text-lg py-6 px-8 rounded-xl transition duration-300">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between pt-4">
                ...
                <Button 
                    ...
                    className={`font-semibold text-lg py-6 px-8 rounded-xl transition duration-300 ${
                        !canSubmit ? "bg-gray-400 cursor-not-allowed" : "bg-green-600 hover:bg-green-700"
                    }`}
                >
